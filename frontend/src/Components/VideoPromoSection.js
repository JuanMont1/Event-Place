...
import { FaGraduationCap, FaTheaterMasks, FaComments, FaYoutube } from "react-icons/fa";
      ...
      <Row className="justify-content-center text-center text-white mb-16">
        <Col lg={8}>
          ...
          <p className="text-xl mb-10 opacity-90 leading-relaxed">
            Sumérgete en el fascinante mundo de eventos de la Universidad de Cundinamarca. 
            Desde conferencias académicas hasta presentaciones culturales, todo está a tu alcance.
          </p>
        </Col>
      </Row>
      <Row className="justify-content-center mb-16">
        <Col md={4} className="mb-8 mb-md-0">
          <div className="feature-card bg-white bg-opacity-10 p-6 rounded-lg text-center text-white">
            ...
            <h3 className="text-2xl font-semibold mb-2">Conferencias académicas en vivo</h3>
            <p className="opacity-80">Amplía tus conocimientos con expertos en diversas áreas.</p>
          </div>
        </Col>
        <Col md={4} className="mb-8 mb-md-0">
          <div className="feature-card bg-white bg-opacity-10 p-6 rounded-lg text-center text-white">
            <FaTheaterMasks className="text-5xl mb-4 text-yellow-300 mx-auto" />
            <h3 className="text-2xl font-semibold mb-2">Presentaciones culturales exclusivas</h3>
            <p className="opacity-80">Disfruta de espectáculos artísticos y culturales únicos.</p>
          </div>
        </Col>
        <Col md={4}>
          <div className="feature-card bg-white bg-opacity-10 p-6 rounded-lg text-center text-white">
            <FaComments className="text-5xl mb-4 text-yellow-300 mx-auto" />
            <h3 className="text-2xl font-semibold mb-2">Debates y foros interactivos</h3>
            <p className="opacity-80">Participa en discusiones enriquecedoras sobre temas actuales.</p>
          </div>
        </Col>
      </Row>
